...
$aTabsStatic = [
    [
        'DIV' => 'crm',
        'TAB' => 'Ваша настройка',//Loc::getMessage('EMPTY_CONFIG_TITLE'),
        'ICON' => 'dis_settings',
        'TITLE' => 'Ваша настройка',//Loc::getMessage('EMPTY_CONFIG_TITLE'),
        'OPTIONS' => [
            [
                'EMPTY_CONFIG',
                'Ваша настройка',//Loc::getMessage('EMPTY_CONFIG_TITLE'),
                '',
                [
                    'text',
                    50,
            ...
            [
                'CRM_ENTITY_ID',
                'CRM сделка',//Loc::getMessage('EMPTY_CONFIG_TITLE'),
                \CCrmOwnerType::Deal,
                [
                    'text',
                    50,
