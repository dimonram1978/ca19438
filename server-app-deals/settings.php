<?php
define('C_REST_CLIENT_ID','local.68af698965a125.64353997');//Application ID
define('C_REST_CLIENT_SECRET','Tk3WT5nbJ8jqcjtPuLrz0UHgMeYBaH3JecwjaLctwgReN1PrNy');//Application key
// or
